...
/*=========================================
	...
	class Eventpress_WP_Button_Customize_Control extends WP_Customize_Control {
		...
		?>
			<div class="premium_info">
				<ul>
					...
					<li><a class="free-pro" href="https://www.nayrathemes.com/eventpress-pro/" target="_blank"><i class="dashicons dashicons-visibility"></i><?php _e( 'Free Vs Pro','eventpress' ); ?> </a></li>
	...
	$wp_customize->add_control( new Eventpress_WP_Button_Customize_Control( $wp_customize, 'premium_info_buttons', array(
