...
describe( 'Test Publish Guide Component', () => {
	...
	it( 'Should notify the nux api when a publish guide step is skipped or completed', () => {
		...
		cy.get( '[data-eid="wp.editor.guide/item/site_info.panel.click"]' ).click();
		cy.get( '[data-eid="wp.editor.guide/item/site_info.edit.click"]' ).click();
		cy.get( '[data-eid="wp.editor.guide/item/site_info.input_title.click"]' ).click().type( 'test' );
		cy.get( '[data-eid="wp.editor.guide/item/site_info.input_description.click"]' ).click().type( 'test' );
		cy.get( '[data-eid="wp.editor.guide/item/site_info.save.click"]' ).click();
		...
		cy.get( '[data-eid="wp.editor.guide/item/add_domain.panel.click"]' ).click();
		cy.get( '[data-eid="wp.editor.guide/item/add_domain.skip.click"]' ).first().click();
