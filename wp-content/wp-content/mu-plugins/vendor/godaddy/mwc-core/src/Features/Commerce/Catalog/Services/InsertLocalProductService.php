...
class InsertLocalProductService extends AbstractInsertLocalResourceService
{
     ...
     * @param InsertMissingAttachmentsService $insertMissingAttachmentsService
     */
    public function __construct(ProductBaseAdapter $productBaseAdapter, ProductsMappingServiceContract $productsMappingService, InsertMissingAttachmentsService $insertMissingAttachmentsService)
    {
