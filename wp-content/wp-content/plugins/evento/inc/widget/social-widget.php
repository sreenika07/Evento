...
class evento_social_icon_widget extends WP_Widget{
		// Construct
		public function __construct() {
			...
			parent::__construct(
				...
				array(
				"classname" => 'evento_social_icon_widget',
		...
		function eventpress_enqueue_admin_scripts() { 			
			wp_enqueue_script( 'social-icon-widget-js', EVENTO_PLUGIN_URL.'inc/widget/js/main.js', array( 'jquery', 'jquery-ui-sortable' ) );
			wp_enqueue_style( 'social-icon-widget-css', EVENTO_PLUGIN_URL . 'inc/widget/css/admin.css', false );
		}
